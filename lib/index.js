...
exports.sha3 = exports.web3.utils.sha3;
exports.getNonce = () => {
    return exports.web3.utils.randomHex(5);
};
exports.hex2bytes = (hex) => {
    if (typeof hex === 'string') {
        return exports.web3.utils.hexToBytes(hex.startsWith('0x') ? hex : '0x' + hex);
    }
...
exports.bytes2hex = (bytes) => {
    return exports.web3.utils.bytesToHex(bytes);
};
const signer = ({ privateKey, data = '', nonce = exports.getNonce(), quota, validUntilBlock, value = '', version = 0, chainId = 1, to = '', }) => {
    if (!privateKey) {
    ...
    var key = exports.ec.keyFromPrivate(privateKey.startsWith('0x') ? privateKey.slice(2) : privateKey, 'hex');
    ...
    const hexUnverifiedTx = exports.web3.utils.bytesToHex(serializedUnverifiedTx);
