...
const content = '';
const unsigner = (hexUnverifiedTransaction) => {
    ...
    const pubPoint = index_1.ec.recoverPubKey(msg, sign, sign.recoveryParam);
    const publicKey = pubPoint.encode('hex').slice(2);
    console.log(index_1.sha3(publicKey).slice(-40));
